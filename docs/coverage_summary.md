...
Tools with no direct MavSDK call (4; e.g. deprecated stubs that only return an error message): `calibrate`, `control_managed_mission`, `get_mission_status`, `start_managed_mission`
